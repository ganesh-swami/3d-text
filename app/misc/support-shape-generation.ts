...
export function generateSupportShape(
  ...
  if (false && hasHandle && handleSettings?.position === 'bottom') {
    const handleStartX =
  ...
  if (false && hasHandle && handleSettings?.position === 'right') {
  ...
  if (false && hasHandle && handleSettings?.position === 'top') {
  ...
  if (false && hasHandle && handleSettings?.position === 'left') {
  ...
  if (false && handleSettings?.type && handleSettings.type === 'hole') {
